...
{  
	...
	echo "Mostrando registros " . $control3 . " al " . $rector . " de " . $nfilas2 . " [<a href='http://localhost/DS7/lab8/lab81.php?control2= " . $rector . "'>Anterior</a>|<a href='http://localhost/DS7/lab8/lab81.php?control= " . $rector . "'>Siguiente</a>]";  
    }
    else if($rector>=$nfilas2)
    {
    	echo "Mostrando registros " . $control3 . " al " . $nfilas2 . " de " . $nfilas2 . " [<a href='http://localhost/DS7/lab8/lab81.php?control2= " . $rector . "'>Anterior</a>|Siguiente]";
    }
    else if($rector==$cali){
    	echo "Mostrando registros " . $control3 . " al " . $rector . " de " . $nfilas2 . " [Anterior|<a href='http://localhost/DS7/lab8/lab81.php?control= " . $rector . "'>Siguiente</a>]"; 
    }
    else{
